...
public:
	...
	enum ListeSons{ M9_FIRE, MP5K_FIRE, AK47_FIRE, AWP_FIRE, GUN_DRAW, FLESH_IMPACT, STEP1, STEP2, STEP3, STEP4, STEP5, STEP6, MUSIC1, DROWNING, GASPING, WATERSTEP1, WATERSTEP2,WATERSTEP3, WATERSTEP4
